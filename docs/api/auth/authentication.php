    ...
    try {
        ...
        $sql = "INSERT INTO customer 
               (FirstName, LastName, Email, Password, ContactNumber, 
                ...
                SatisfactionRating, CreatedDate) 
               VALUES (?, ?, ?, ?, ?, 'Reservation', 0, 0, 0, 0.00, NOW())";
...
// ============================================================
    ...
    try {
        ...
        // Get customer (check all account statuses first)
        ...
        // Update last login and reactivate account if inactive
        $updateSql = "UPDATE customer SET LastLoginDate = NOW(), LastTransactionDate = NOW() WHERE CustomerID = ?";

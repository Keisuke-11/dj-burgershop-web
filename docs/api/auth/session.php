...
function requireLogin() {
    if (!isUserLoggedIn()) {
        ...
        $missing = [];
        if (!isset($_SESSION['customer_id'])) $missing[] = 'customer_id';
        if (!isset($_SESSION['customer_email'])) $missing[] = 'customer_email';
        if (!isset($_SESSION['login_time'])) $missing[] = 'login_time';

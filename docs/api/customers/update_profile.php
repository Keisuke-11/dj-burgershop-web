...
$updateSql = "UPDATE customer SET FirstName = ?, LastName = ?, Email = ?, ContactNumber = ? WHERE CustomerID = ?";
...
$selectSql = "SELECT CustomerID, FirstName, LastName, Email, ContactNumber FROM customer WHERE CustomerID = ?";

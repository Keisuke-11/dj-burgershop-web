...
try {
    ...
    $sql = "SELECT ReservationID, ReservationDate as EventDate, ReservationTime as EventTime, 
                   'N/A' as EventType, NumberOfCustomers as NumberOfGuests, 
                   COALESCE(ReservationStatus, 'Pending') as ReservationStatus, 
                   'Pickup' as DeliveryOption, Notes as DeliveryAddress
            FROM reservation 
            WHERE CustomerID = ?

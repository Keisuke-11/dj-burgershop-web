...
try {
    ...
    $reservation_sql = "INSERT INTO reservation 
                        (CustomerID, ReservationDate, ReservationTime, 
                         NumberOfCustomers, SeatType, ReservationStatus) 
                        VALUES (?, ?, ?, ?, ?, ?)";
    ...
    $payment_sql = "INSERT INTO reservationpayment 
    ...
    // ============================================================
    // LOG TRANSACTION (SKIPPED - customer_logs table removed)
    // ============================================================

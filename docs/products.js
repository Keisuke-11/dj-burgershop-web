document.addEventListener('DOMContentLoaded', () => {
    ...
    function filterProductsByCategory(categoryName) {
        if (categoryName === 'All' || categoryName === 'All Categories') return allProducts;
    ...
    async function showProductSelection() {
        try {
            ...
            const initialProducts = filterProductsByCategory('Burgers'); // Default to Burgers

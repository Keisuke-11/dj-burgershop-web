...
try {
    ...
    $checkSql = "SELECT ReservationStatus, ReservationDate as EventDate FROM reservation 
    ...
    */
    ...
    $updateReservationSql = "UPDATE reservation 
    ...
    $updatePaymentSql = "UPDATE reservationpayment 
